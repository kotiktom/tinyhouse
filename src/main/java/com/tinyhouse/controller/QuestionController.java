...
public class QuestionController {
	...
	/*
	 * @PostMapping("/saveque") public String save(InputType inputtype) {
	 * inputrepo.save(inputtype); return "redirect:index"; }
	 */
	...
	/*
	 * @GetMapping("/test") public String Home2(Model model) {
